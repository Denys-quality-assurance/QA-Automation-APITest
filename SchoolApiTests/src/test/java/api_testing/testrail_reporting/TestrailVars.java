package api_testing.testrail_reporting;

public class TestrailVars {
    //TestRail
    ...
    public static String testRailProjectId = "4";
    public static String testRailRunPrefix = "School_API";
}
